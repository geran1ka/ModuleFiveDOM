...
export const showModal = async (err, goods = null) => {
  ...
  const imageWrapper = document.querySelector('.img__wrapper');
  const preview = document.querySelector('.img__preview');
  const imageError = document.querySelector('.img__error');
  const addImg = document.querySelector('.img__label');
  const btnDelImg = document.querySelector('.img__btn-delete');
