...
const createRow = ({id, title, category, units, count, price, discont, images}) => {
  ...
  row.innerHTML = `
    ...
    <td class="table__cell table__cell-name">${title}</td>
    <td class="table__cell table__cell-category">${category}</td>
    ...
    <td class="table__cell table__cell-btn">
      <button class="button button-table button-table_image" type="button"> 
        ...
        <button class="button button-table button-table_edit" type="button">
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <button class="button button-table button-table_del" type="button">
        <svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
